...
class FolderCreationResponse(BaseModel):
    """
    ...
    is_project: StrictBool
    __properties: ClassVar[List[str]] = ["id", "name", "parent_id", "created_at", "updated_at", "project_id", "is_project"]
