...
class ConnectionCreateRequest(BaseModel):
    ...
    provider: StrictStr = Field(description="The application type of the connection")
    ...
    __properties: ClassVar[List[str]] = ["name", "provider", "parent_id", "folder_id", "external_id", "shell_connection", "input"]
