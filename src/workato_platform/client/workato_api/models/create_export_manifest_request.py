...
class CreateExportManifestRequest(BaseModel):
    """
    CreateExportManifestRequest
    """ # noqa: E501
    export_manifest: ExportManifestRequest
    __properties: ClassVar[List[str]] = ["export_manifest"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of export_manifest
        if self.export_manifest:
            _dict['export_manifest'] = self.export_manifest.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "export_manifest": ExportManifestRequest.from_dict(obj["export_manifest"]) if obj.get("export_manifest") is not None else None
        })
        return _obj
