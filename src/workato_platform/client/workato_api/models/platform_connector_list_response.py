...
class PlatformConnectorListResponse(BaseModel):
    """
    PlatformConnectorListResponse
    """ # noqa: E501
    items: List[PlatformConnector]
    count: StrictInt
    page: StrictInt
    per_page: StrictInt
    __properties: ClassVar[List[str]] = ["items", "count", "page", "per_page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PlatformConnector.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "count": obj.get("count"),
            "page": obj.get("page"),
