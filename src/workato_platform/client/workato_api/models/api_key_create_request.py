...
class ApiKeyCreateRequest(BaseModel):
    ...
    active: StrictBool = Field(description="Indicates whether the API key is enabled or disabled. Disabled keys cannot call any APIs")
    ip_allow_list: Optional[List[StrictStr]] = Field(default=None, description="List of IP addresses to add to the allowlist")
    ip_deny_list: Optional[List[StrictStr]] = Field(default=None, description="List of IP addresses to deny requests from")
    __properties: ClassVar[List[str]] = ["name", "active", "ip_allow_list", "ip_deny_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip_allow_list": obj.get("ip_allow_list"),
            "ip_deny_list": obj.get("ip_deny_list")
        })
        return _obj
