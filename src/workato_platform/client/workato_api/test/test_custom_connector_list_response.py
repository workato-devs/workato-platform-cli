...
class TestCustomConnectorListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomConnectorListResponse:
        """Test CustomConnectorListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomConnectorListResponse`
        """
        model = CustomConnectorListResponse()
        if include_optional:
    ...
    def testCustomConnectorListResponse(self):
        """Test CustomConnectorListResponse"""
