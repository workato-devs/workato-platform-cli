...
class TestDataTableCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataTableCreateRequest:
        """Test DataTableCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataTableCreateRequest`
        """
        model = DataTableCreateRequest()
        if include_optional:
            return DataTableCreateRequest(
    ...
    def testDataTableCreateRequest(self):
        """Test DataTableCreateRequest"""
