...
class TestApiClientApiCollectionsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiClientApiCollectionsInner:
        """Test ApiClientApiCollectionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiClientApiCollectionsInner`
        """
        model = ApiClientApiCollectionsInner()
        if include_optional:
            return ApiClientApiCollectionsInner(
                id = 1,
    ...
    def testApiClientApiCollectionsInner(self):
        """Test ApiClientApiCollectionsInner"""
