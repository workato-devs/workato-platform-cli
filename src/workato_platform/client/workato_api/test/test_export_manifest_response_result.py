...
class TestExportManifestResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExportManifestResponseResult:
        ...
        # uncomment below to create an instance of `ExportManifestResponseResult`
        """
        model = ExportManifestResponseResult()
        if include_optional:
            return ExportManifestResponseResult(
                id = 12,
                name = 'Test Manifest',
    ...
    def testExportManifestResponseResult(self):
        """Test ExportManifestResponseResult"""
