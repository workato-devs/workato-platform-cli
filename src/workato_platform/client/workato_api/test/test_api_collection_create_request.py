...
class TestApiCollectionCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiCollectionCreateRequest:
        """Test ApiCollectionCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiCollectionCreateRequest`
        """
        model = ApiCollectionCreateRequest()
        if include_optional:
    ...
    def testApiCollectionCreateRequest(self):
        """Test ApiCollectionCreateRequest"""
