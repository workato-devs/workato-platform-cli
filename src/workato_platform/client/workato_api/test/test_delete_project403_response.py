...
class TestDeleteProject403Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeleteProject403Response:
        """Test DeleteProject403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteProject403Response`
        """
        model = DeleteProject403Response()
        if include_optional:
            return DeleteProject403Response(
    ...
    def testDeleteProject403Response(self):
        """Test DeleteProject403Response"""
