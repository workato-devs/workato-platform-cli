...
class TestCustomConnectorCodeResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomConnectorCodeResponse:
        """Test CustomConnectorCodeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomConnectorCodeResponse`
        """
    ...
    def testCustomConnectorCodeResponse(self):
        """Test CustomConnectorCodeResponse"""
