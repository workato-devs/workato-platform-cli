...
class TestRecipeStartResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecipeStartResponse:
        """Test RecipeStartResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecipeStartResponse`
        """
        model = RecipeStartResponse()
        if include_optional:
    ...
    def testRecipeStartResponse(self):
        """Test RecipeStartResponse"""
