...
class TestValidationErrorErrorsValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValidationErrorErrorsValue:
        """Test ValidationErrorErrorsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationErrorErrorsValue`
        """
        model = ValidationErrorErrorsValue()
        if include_optional:
    ...
    def testValidationErrorErrorsValue(self):
        """Test ValidationErrorErrorsValue"""
