...
class TestDataTableCreateResponse(unittest.TestCase):
    """DataTableCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataTableCreateResponse:
        """Test DataTableCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataTableCreateResponse`
        """
        model = DataTableCreateResponse()
        if include_optional:
            return DataTableCreateResponse(
                data = workato_platform_cli.client.workato_api.models.data_table.DataTable(
    ...
    def testDataTableCreateResponse(self):
        """Test DataTableCreateResponse"""
