...
class TestApiClientApiPoliciesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiClientApiPoliciesInner:
        """Test ApiClientApiPoliciesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiClientApiPoliciesInner`
        """
        model = ApiClientApiPoliciesInner()
        if include_optional:
            return ApiClientApiPoliciesInner(
                id = 2,
    ...
    def testApiClientApiPoliciesInner(self):
        """Test ApiClientApiPoliciesInner"""
