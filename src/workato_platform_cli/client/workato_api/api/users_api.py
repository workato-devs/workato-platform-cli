...
class UsersApi:
    ...
    async def get_workspace_details(
        ...
        _param = self._get_workspace_details_serialize(
    ...
    @validate_call
    async def get_workspace_details_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_workspace_details_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_workspace_details_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
