...
class PackageDetailsResponseRecipeStatusInner(BaseModel):
    """
    PackageDetailsResponseRecipeStatusInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    import_result: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "import_result"]
    ...
    def import_result_validate_enum(cls, value):
        ...
        if value not in set(['no_update_or_updated_without_restart', 'restarted', 'stopped', 'restart_failed']):
            raise ValueError("must be one of enum values ('no_update_or_updated_without_restart', 'restarted', 'stopped', 'restart_failed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "import_result": obj.get("import_result")
        })
        return _obj
