...
class ApiClientListResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[ApiClient]
    count: StrictInt = Field(description="Total number of API clients")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApiClient.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count"),
            "page": obj.get("page"),
