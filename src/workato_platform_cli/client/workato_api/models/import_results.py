...
class ImportResults(BaseModel):
    ...
    failed_endpoints: StrictInt
    failed_actions: List[StrictStr]
    __properties: ClassVar[List[str]] = ["success", "total_endpoints", "failed_endpoints", "failed_actions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed_endpoints": obj.get("failed_endpoints"),
            "failed_actions": obj.get("failed_actions")
        })
        return _obj
