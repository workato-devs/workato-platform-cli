...
class RecipeConnectionUpdateRequest(BaseModel):
    """
    RecipeConnectionUpdateRequest
    """ # noqa: E501
    adapter_name: StrictStr = Field(description="The internal name of the connector")
    connection_id: StrictInt = Field(description="The ID of the connection that replaces the existing one")
    __properties: ClassVar[List[str]] = ["adapter_name", "connection_id"]
