...
class ConnectorVersion(BaseModel):
    ...
    """ # noqa: E501
    version: StrictInt
    version_note: Optional[StrictStr]
    created_at: datetime
    released_at: datetime
    __properties: ClassVar[List[str]] = ["version", "version_note", "created_at", "released_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if version_note (nullable) is None
        # and model_fields_set contains the field
        if self.version_note is None and "version_note" in self.model_fields_set:
            _dict['version_note'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "version_note": obj.get("version_note"),
