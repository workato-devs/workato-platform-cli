...
class FolderAssetsResponse(BaseModel):
    """
    FolderAssetsResponse
    """ # noqa: E501
    result: FolderAssetsResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": FolderAssetsResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
