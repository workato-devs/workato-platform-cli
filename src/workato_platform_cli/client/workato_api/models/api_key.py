...
class ApiKey(BaseModel):
    ...
    name: StrictStr
    auth_type: StrictStr
    ip_allow_list: Optional[List[StrictStr]] = Field(default=None, description="List of IP addresses in the allowlist")
    ip_deny_list: Optional[List[StrictStr]] = Field(default=None, description="List of IP addresses to deny requests from")
    active: StrictBool
    active_since: datetime
    auth_token: StrictStr = Field(description="The generated API token")
    __properties: ClassVar[List[str]] = ["id", "name", "auth_type", "ip_allow_list", "ip_deny_list", "active", "active_since", "auth_token"]
