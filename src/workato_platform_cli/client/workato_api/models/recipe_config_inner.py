...
class RecipeConfigInner(BaseModel):
    """
    RecipeConfigInner
    """ # noqa: E501
    ...
    skip_validation: Optional[StrictBool] = None
    account_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["keyword", "name", "provider", "skip_validation", "account_id"]
