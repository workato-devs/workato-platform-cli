...
class PicklistRequest(BaseModel):
    ...
    PicklistRequest
    """ # noqa: E501
    pick_list_name: StrictStr = Field(description="Name of the pick list")
    pick_list_params: Optional[Dict[str, Any]] = Field(default=None, description="Picklist parameters, required in some picklists")
    __properties: ClassVar[List[str]] = ["pick_list_name", "pick_list_params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pick_list_name": obj.get("pick_list_name"),
            "pick_list_params": obj.get("pick_list_params")
        })
        return _obj
