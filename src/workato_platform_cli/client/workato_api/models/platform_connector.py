...
class PlatformConnector(BaseModel):
    ...
    secondary: StrictBool
    triggers: List[ConnectorAction]
    actions: List[ConnectorAction]
    __properties: ClassVar[List[str]] = ["name", "title", "categories", "oauth", "deprecated", "secondary", "triggers", "actions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "triggers": [ConnectorAction.from_dict(_item) for _item in obj["triggers"]] if obj.get("triggers") is not None else None,
